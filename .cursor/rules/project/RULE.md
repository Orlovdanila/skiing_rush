...
1. **Открой `@summary_plan.md`** — проверь "Next Tasks" и "Заглушки в коде"
2. **Не создавай дубли** — проверь существующие файлы
...
3. Обнови `summary_plan.md` если задача завершена
